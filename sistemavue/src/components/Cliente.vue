...
<v-layout align-start>
  ...
  <v-flex>
    <v-data-table :headers="headers" :items="clientes" :search="searchedWord" sort-by="nombre" class="elevation-1">
      <template v-slot:top>
      ...
      <template v-slot:items="cliente">
        <td>{{cliente.item.nombre}}</td>
        <td>{{cliente.item.tipo_persona}}</td>
        <td>{{cliente.item.tipo_documento}}</td>
        <td>{{cliente.item.num_document}}</td>
        <td>{{cliente.item.direccion}}</td>
        <td>{{cliente.item.telefono}}</td>
        <td>{{cliente.item.email}}</td>
        <td>{{cliente.item.estado}}</td>
      </template>
